...
$arr['title'] = 'ลบรายชื่อติดต่อ';
$arr['title'] .= '<br>'.$data->name;

$arr['form'] = '<form  method="post" action="'.asset( 'api/v1/contacts/'.$data->id ).'" data-plugin="formSubmit"></form>';
...
$arr['button'] = [
    '<button type="submit" class="btn btn-danger btn-submit ml-2"><span class="btn-text">ลบถาวร</span></button>',
    '<button type="button" class="btn btn-outline-secondary ml-2" data-action="close"><span class="btn-text">ยกเลิก</span></button>'
];
